...
func TestResolvePreviewShape(t *testing.T) {
	const body = `{"resolve_x":0,"resolve_z":0,"resolved":{"found":true,"cell_id":"cell_root","grpc_endpoint":"x"},"last_cell":{"found":false},"cell_id_mismatch":false}`
