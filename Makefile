...
merge-auto-e2e-smoke:
	MERGE_VERIFY_AUTOMATION_STATE=1 bash scripts/grid-merge-e2e.sh

# Full auto-cycle smoke: force split, then policy-driven auto merge, with Redis marker checks.
full-cycle-e2e-smoke:
	bash scripts/grid-full-cycle-e2e.sh
